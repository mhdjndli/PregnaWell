...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-white shadow-[0_15px_40px_-12px_rgba(37,211,102,0.7)] transition hover:scale-105"
    >
      <svg
      ...
      <span className="hidden sm:inline text-sm font-semibold pr-1">Chat</span>
    </a>
  );
}
